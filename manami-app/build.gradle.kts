dependencies {
    ...
    implementation("io.github.manamiproject:modb-kitsu:3.0.0")
    implementation("io.github.manamiproject:modb-mal:3.0.0")
    implementation("io.github.manamiproject:modb-notify:3.0.0")
