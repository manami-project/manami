...
dependencies {
    ...
    implementation("io.github.manamiproject:modb-anidb:3.1.13")
    ...
    implementation("io.github.manamiproject:modb-anisearch:1.2.13")
    implementation("io.github.manamiproject:modb-kitsu:3.1.10")
    implementation("io.github.manamiproject:modb-livechart:1.1.12")
    implementation("io.github.manamiproject:modb-mal:3.1.11")
    implementation("io.github.manamiproject:modb-notify:3.2.11")
