...
internal class XmlFileParserTest {
    ...
    fun `handles XML files`() {
        ...
        val parser = XmlFileParser(testCache)
    ...
    inner class CompanionObjectTests {
        ...
        fun `instance property always returns same instance`() {
            // given
            val previous = XmlFileParser.instance

            // when
            val result = XmlFileParser.instance

            // then
            assertThat(result).isExactlyInstanceOf(XmlFileParser::class.java)
