...
internal class AnimeListResultsViewModel(private val app: Manami = Manami.instance): DefaultAnimeTableViewModel<AnimeListEntry>() {
    ...
    override val source: StateFlow<List<AnimeListEntry>>
        get() = app.findByTitleState
            .map { it.animeListResults.toList() }
            .stateIn(
    ...
    internal companion object {
        /**
         * Singleton of [AnimeListResultsViewModel]
         * @since 4.0.0
         */
        val instance: AnimeListResultsViewModel by lazy { AnimeListResultsViewModel() }
    }
}