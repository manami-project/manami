...
public class RelatedAnimeExtractorTest {
  ...
  public void extractRelatedAnime() {
    ...
    assertThat(result.contains(new InfoLink("http://myanimelist.net/anime/849"))).isTrue();
    assertThat(result.contains(new InfoLink("http://myanimelist.net/anime/7311"))).isTrue();
    assertThat(result.contains(new InfoLink("http://myanimelist.net/anime/26351"))).isTrue();
  }
