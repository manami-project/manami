...
public class ImportMigrationPostProcessorTest {
  ...
  public void testMigrationStopsInvalidToolVersion() {
    ...
    final FilterEntry entry1 = new FilterEntry("Death Note", entry1Thumb,
        new InfoLink("http://myanimelist.net/anime/1535"));
    final FilterEntry entry2 = new FilterEntry("Fullmetal Panic!", entry2Thumb,
    ...
    final ImportMigrationPostProcessor processor = new ImportMigrationPostProcessor("unknown",
        "2.10.2", newArrayList(), filterListEntries, newArrayList());
    ...
    assertThat(entry3.getThumbnail())
  ...
  public void testMigrationStopsInvalidDocumentVersion() {
    ...
    final ImportMigrationPostProcessor processor = new ImportMigrationPostProcessor("2.10.3",
        "2.?.2", newArrayList(), filterListEntries, newArrayList());
  ...
  public void testMigration2103WorksForFilterList() {
    ...
    final FilterEntry entry1 = new FilterEntry("Death Note",
        "http://cdn.myanimelist.net/images/anime/9/9453t.jpg",
        new InfoLink("http://myanimelist.net/anime/1535"));
    final FilterEntry entry2 = new FilterEntry("Fullmetal Panic!", fmpThumb,
        new InfoLink("http://anidb.net/perl-bin/animedb.pl?show=anime&aid=17"));
    final FilterEntry entry3 = new FilterEntry("Code Geass: Hangyaku no Lelouch R2",
        new InfoLink("https://myanimelist.net/anime/2904/Code_Geass__Hangyaku_no_Lelouch_R2"));
    ...
    // then
    assertThat(entry1.getThumbnail())
        .isEqualTo("https://myanimelist.cdn-dena.com/images/anime/9/9453t.jpg");
  ...
  public void testMigration2103WorksForWatchList() {
    // given
    final String fmpThumb = "http://img7.anidb.net/pics/anime/thumbs/50x65/129527.jpg-thumb.jpg";
    final WatchListEntry entry1 = new WatchListEntry("Death Note",
        "http://cdn.myanimelist.net/images/anime/9/9453t.jpg",
        new InfoLink("http://myanimelist.net/anime/1535"));
    final WatchListEntry entry2 = new WatchListEntry("Fullmetal Panic!", fmpThumb,
        new InfoLink("http://anidb.net/perl-bin/animedb.pl?show=anime&aid=17"));
    final WatchListEntry entry3 = new WatchListEntry("Code Geass: Hangyaku no Lelouch R2",
        new InfoLink("https://myanimelist.net/anime/2904/Code_Geass__Hangyaku_no_Lelouch_R2"));

    final List<WatchListEntry> watchListEntries = newArrayList(entry1, entry2, entry3);

    final ImportMigrationPostProcessor processor = new ImportMigrationPostProcessor("2.10.3",
        "2.10.2", newArrayList(), newArrayList(), watchListEntries);
